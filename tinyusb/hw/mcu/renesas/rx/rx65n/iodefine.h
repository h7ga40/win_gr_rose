...
#define	CAN0		(*(volatile struct st_can      *)&IORegister[0x90200 - 0x80000])
#define	CAN1		(*(volatile struct st_can      *)&IORegister[0x91200 - 0x80000])
#define	CMT			(*(volatile struct st_cmt      *)&IORegister[0x88000 - 0x80000])
#define	CMT0		(*(volatile struct st_cmt0     *)&IORegister[0x88002 - 0x80000])
#define	CMT1		(*(volatile struct st_cmt0     *)&IORegister[0x88008 - 0x80000])
#define	CMT2		(*(volatile struct st_cmt0     *)&IORegister[0x88012 - 0x80000])
#define	CMT3		(*(volatile struct st_cmt0     *)&IORegister[0x88018 - 0x80000])
#define	CMTW0		(*(volatile struct st_cmtw     *)&IORegister[0x94200 - 0x80000])
#define	CMTW1		(*(volatile struct st_cmtw     *)&IORegister[0x94280 - 0x80000])
#define	CRC			(*(volatile struct st_crc      *)&IORegister[0x88280 - 0x80000])
#define	DA			(*(volatile struct st_da       *)&IORegister[0x88040 - 0x80000])
#define	DMAC		(*(volatile struct st_dmac     *)&IORegister[0x82200 - 0x80000])
#define	DMAC0		(*(volatile struct st_dmac0    *)&IORegister[0x82000 - 0x80000])
#define	DMAC1		(*(volatile struct st_dmac1    *)&IORegister[0x82040 - 0x80000])
#define	DMAC2		(*(volatile struct st_dmac1    *)&IORegister[0x82080 - 0x80000])
#define	DMAC3		(*(volatile struct st_dmac1    *)&IORegister[0x820C0 - 0x80000])
#define	DMAC4		(*(volatile struct st_dmac1    *)&IORegister[0x82100 - 0x80000])
#define	DMAC5		(*(volatile struct st_dmac1    *)&IORegister[0x82140 - 0x80000])
#define	DMAC6		(*(volatile struct st_dmac1    *)&IORegister[0x82180 - 0x80000])
#define	DMAC7		(*(volatile struct st_dmac1    *)&IORegister[0x821C0 - 0x80000])
#define	DOC			(*(volatile struct st_doc      *)&IORegister[0x8B080 - 0x80000])
#define	DRW2D		(*(volatile struct st_drw2d    *)&IORegister[0xE3000 - 0x80000])
#define	DTC			(*(volatile struct st_dtc      *)&IORegister[0x82400 - 0x80000])
#define	EDMAC0		(*(volatile struct st_edmac    *)&IORegister[0xC0000 - 0x80000])
#define	ELC			(*(volatile struct st_elc      *)&IORegister[0x8B100 - 0x80000])
#define	ETHERC0		(*(volatile struct st_etherc   *)&IORegister[0xC0100 - 0x80000])
#define	EXDMAC		(*(volatile struct st_exdmac   *)&IORegister[0x82A00 - 0x80000])
#define	EXDMAC0		(*(volatile struct st_exdmac0  *)&IORegister[0x82800 - 0x80000])
#define	EXDMAC1		(*(volatile struct st_exdmac1  *)&IORegister[0x82840 - 0x80000])
#define	FLASH		(*(volatile struct st_flash    *)&IORegister[0x81000 - 0x80000])
#define	GLCDC		(*(volatile struct st_glcdc    *)&IORegister[0xE0000 - 0x80000])
#define	ICU			(*(volatile struct st_icu      *)&IORegister[0x87000 - 0x80000])
#define	IWDT		(*(volatile struct st_iwdt     *)&IORegister[0x88030 - 0x80000])
#define	MMCIF		(*(volatile struct st_mmcif    *)&IORegister[0x88500 - 0x80000])
#define	MPC			(*(volatile struct st_mpc      *)&IORegister[0x8C100 - 0x80000])
#define	MPU			(*(volatile struct st_mpu      *)&IORegister[0x86400 - 0x80000])
#define	MTU			(*(volatile struct st_mtu      *)&IORegister[0xC120A - 0x80000])
#define	MTU0		(*(volatile struct st_mtu0     *)&IORegister[0xC1290 - 0x80000])
#define	MTU1		(*(volatile struct st_mtu1     *)&IORegister[0xC1290 - 0x80000])
#define	MTU2		(*(volatile struct st_mtu2     *)&IORegister[0xC1292 - 0x80000])
#define	MTU3		(*(volatile struct st_mtu3     *)&IORegister[0xC1200 - 0x80000])
#define	MTU4		(*(volatile struct st_mtu4     *)&IORegister[0xC1200 - 0x80000])
#define	MTU5		(*(volatile struct st_mtu5     *)&IORegister[0xC1A94 - 0x80000])
#define	MTU6		(*(volatile struct st_mtu6     *)&IORegister[0xC1A00 - 0x80000])
#define	MTU7		(*(volatile struct st_mtu7     *)&IORegister[0xC1A00 - 0x80000])
#define	MTU8		(*(volatile struct st_mtu8     *)&IORegister[0xC1298 - 0x80000])
#define	OFSM		(*(volatile struct st_ofsm     *)&IORegister[0xF5D00 - 0x80000])
#define	PDC			(*(volatile struct st_pdc      *)&IORegister[0xA0500 - 0x80000])
#define	POE3		(*(volatile struct st_poe      *)&IORegister[0x8C4C0 - 0x80000])
#define	PORT0		(*(volatile struct st_port0    *)&IORegister[0x8C000 - 0x80000])
#define	PORT1		(*(volatile struct st_port1    *)&IORegister[0x8C001 - 0x80000])
#define	PORT2		(*(volatile struct st_port2    *)&IORegister[0x8C002 - 0x80000])
#define	PORT3		(*(volatile struct st_port3    *)&IORegister[0x8C003 - 0x80000])
#define	PORT4		(*(volatile struct st_port4    *)&IORegister[0x8C004 - 0x80000])
#define	PORT5		(*(volatile struct st_port5    *)&IORegister[0x8C005 - 0x80000])
#define	PORT6		(*(volatile struct st_port6    *)&IORegister[0x8C006 - 0x80000])
#define	PORT7		(*(volatile struct st_port7    *)&IORegister[0x8C007 - 0x80000])
#define	PORT8		(*(volatile struct st_port8    *)&IORegister[0x8C008 - 0x80000])
#define	PORT9		(*(volatile struct st_port9    *)&IORegister[0x8C009 - 0x80000])
#define	PORTA		(*(volatile struct st_porta    *)&IORegister[0x8C00A - 0x80000])
#define	PORTB		(*(volatile struct st_portb    *)&IORegister[0x8C00B - 0x80000])
#define	PORTC		(*(volatile struct st_portc    *)&IORegister[0x8C00C - 0x80000])
#define	PORTD		(*(volatile struct st_portd    *)&IORegister[0x8C00D - 0x80000])
#define	PORTE		(*(volatile struct st_porte    *)&IORegister[0x8C00E - 0x80000])
#define	PORTF		(*(volatile struct st_portf    *)&IORegister[0x8C00F - 0x80000])
#define	PORTG		(*(volatile struct st_portg    *)&IORegister[0x8C010 - 0x80000])
#define	PORTJ		(*(volatile struct st_portj    *)&IORegister[0x8C012 - 0x80000])
#define	PPG0		(*(volatile struct st_ppg0     *)&IORegister[0x881E6 - 0x80000])
#define	PPG1		(*(volatile struct st_ppg1     *)&IORegister[0x881F0 - 0x80000])
#define	QSPI		(*(volatile struct st_qspi     *)&IORegister[0x89E00 - 0x80000])
#define	RAM			(*(volatile struct st_ram      *)&IORegister[0x81200 - 0x80000])
#define	RIIC0		(*(volatile struct st_riic     *)&IORegister[0x88300 - 0x80000])
#define	RIIC1		(*(volatile struct st_riic     *)&IORegister[0x88320 - 0x80000])
#define	RIIC2		(*(volatile struct st_riic     *)&IORegister[0x88340 - 0x80000])
#define	RSPI0		(*(volatile struct st_rspi     *)&IORegister[0xD0100 - 0x80000])
#define	RSPI1		(*(volatile struct st_rspi     *)&IORegister[0xD0140 - 0x80000])
#define	RSPI2		(*(volatile struct st_rspi     *)&IORegister[0xD0300 - 0x80000])
#define	RTC			(*(volatile struct st_rtc      *)&IORegister[0x8C400 - 0x80000])
#define	S12AD		(*(volatile struct st_s12ad    *)&IORegister[0x89000 - 0x80000])
#define	S12AD1		(*(volatile struct st_s12ad1   *)&IORegister[0x89100 - 0x80000])
#define	SCI0		(*(volatile struct st_sci0     *)&IORegister[0x8A000 - 0x80000])
#define	SCI1		(*(volatile struct st_sci0     *)&IORegister[0x8A020 - 0x80000])
#define	SCI2		(*(volatile struct st_sci0     *)&IORegister[0x8A040 - 0x80000])
#define	SCI3		(*(volatile struct st_sci0     *)&IORegister[0x8A060 - 0x80000])
#define	SCI4		(*(volatile struct st_sci0     *)&IORegister[0x8A080 - 0x80000])
#define	SCI5		(*(volatile struct st_sci0     *)&IORegister[0x8A0A0 - 0x80000])
#define	SCI6		(*(volatile struct st_sci0     *)&IORegister[0x8A0C0 - 0x80000])
#define	SCI7		(*(volatile struct st_sci0     *)&IORegister[0x8A0E0 - 0x80000])
#define	SCI8		(*(volatile struct st_sci0     *)&IORegister[0x8A100 - 0x80000])
#define	SCI9		(*(volatile struct st_sci0     *)&IORegister[0x8A120 - 0x80000])
#define	SCI10		(*(volatile struct st_sci10    *)&IORegister[0xD0040 - 0x80000])
#define	SCI11		(*(volatile struct st_sci10    *)&IORegister[0xD0060 - 0x80000])
#define	SCI12		(*(volatile struct st_sci12    *)&IORegister[0x8B300 - 0x80000])
#define	SDHI		(*(volatile struct st_sdhi     *)&IORegister[0x8AC00 - 0x80000])
#define	SDSI		(*(volatile struct st_sdsi     *)&IORegister[0x95000 - 0x80000])
#define	SMCI0		(*(volatile struct st_smci0    *)&IORegister[0x8A000 - 0x80000])
#define	SMCI1		(*(volatile struct st_smci0    *)&IORegister[0x8A020 - 0x80000])
#define	SMCI2		(*(volatile struct st_smci0    *)&IORegister[0x8A040 - 0x80000])
#define	SMCI3		(*(volatile struct st_smci0    *)&IORegister[0x8A060 - 0x80000])
#define	SMCI4		(*(volatile struct st_smci0    *)&IORegister[0x8A080 - 0x80000])
#define	SMCI5		(*(volatile struct st_smci0    *)&IORegister[0x8A0A0 - 0x80000])
#define	SMCI6		(*(volatile struct st_smci0    *)&IORegister[0x8A0C0 - 0x80000])
#define	SMCI7		(*(volatile struct st_smci0    *)&IORegister[0x8A0E0 - 0x80000])
#define	SMCI8		(*(volatile struct st_smci0    *)&IORegister[0x8A100 - 0x80000])
#define	SMCI9		(*(volatile struct st_smci0    *)&IORegister[0x8A120 - 0x80000])
#define	SMCI10		(*(volatile struct st_smci10   *)&IORegister[0xD0040 - 0x80000])
#define	SMCI11		(*(volatile struct st_smci10   *)&IORegister[0xD0060 - 0x80000])
#define	SMCI12		(*(volatile struct st_smci0    *)&IORegister[0x8B300 - 0x80000])
#define	SYSTEM		(*(volatile struct st_system   *)&IORegister[0x80000 - 0x80000])
#define	TEMPS		(*(volatile struct st_temps    *)&IORegister[0x8C500 - 0x80000])
#define	TMR0		(*(volatile struct st_tmr0     *)&IORegister[0x88200 - 0x80000])
#define	TMR1		(*(volatile struct st_tmr1     *)&IORegister[0x88201 - 0x80000])
#define	TMR2		(*(volatile struct st_tmr0     *)&IORegister[0x88210 - 0x80000])
#define	TMR3		(*(volatile struct st_tmr1     *)&IORegister[0x88211 - 0x80000])
#define	TMR01		(*(volatile struct st_tmr01    *)&IORegister[0x88204 - 0x80000])
#define	TMR23		(*(volatile struct st_tmr01    *)&IORegister[0x88214 - 0x80000])
#define	TPU0		(*(volatile struct st_tpu0     *)&IORegister[0x88108 - 0x80000])
#define	TPU1		(*(volatile struct st_tpu1     *)&IORegister[0x88108 - 0x80000])
#define	TPU2		(*(volatile struct st_tpu2     *)&IORegister[0x8810A - 0x80000])
#define	TPU3		(*(volatile struct st_tpu3     *)&IORegister[0x8810A - 0x80000])
#define	TPU4		(*(volatile struct st_tpu4     *)&IORegister[0x8810C - 0x80000])
#define	TPU5		(*(volatile struct st_tpu5     *)&IORegister[0x8810C - 0x80000])
#define	TPUA		(*(volatile struct st_tpua     *)&IORegister[0x88100 - 0x80000])
#define	USB			(*(volatile struct st_usb      *)&IORegister[0xA0400 - 0x80000])
#define	USB0		(*(volatile struct st_usb0     *)&IORegister[0xA0000 - 0x80000])
#define	WDT			(*(volatile struct st_wdt      *)&IORegister[0x88020 - 0x80000])
#define	FLASHCONST	(*(volatile struct st_flashconst  *)&IORegister[0xF7D90 - 0x80000])
#define	TEMPSCONST	(*(volatile struct st_tempsconst  *)&IORegister[0xF7D7C - 0x80000])
#endif
